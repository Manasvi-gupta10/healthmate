...
import { matchSymptoms, MatchResult } from "@/utils/symptomMatcher";
  ...
  const handleAnalyze = async () => {
    ...
    try {
      ...
      if (matchedResults.length === 0) {
        toast.error("Could not find a match for those symptoms. Please try selecting more common symptoms.");
